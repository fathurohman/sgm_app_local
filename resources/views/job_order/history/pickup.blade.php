@extends('layouts.app', ['activePage' => 'history_job_orders'])
@push('css')
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('hist_post') }}" autocomplete="off" id="form-order">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    value="{{$job_order->order_id}}" aria-label="order_id" name="order_id">
                                    </div>
                                    <input id="row-id-hide" type="text" class="form-control"
                                        value="{{ $job_order->order_row}}" name="order_month" hidden>
                                    <input id="month-hide" name="month_order" type="text" class="form-control"
                                        value="{{ $job_order->month}}" hidden>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-3">
                                    <label class="form-control-label" for="input-for"></label>
                                    <input value="{{ $job_order->tipe_order }}" type="text" id="tipe_order_full" class="form-control form-control-alternative"
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('hist_job_order') }}" type="button"
