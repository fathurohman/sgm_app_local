@extends('layouts.app', ['activePage' => 'invoice']) @push('css')
    ...
    <script type="text/javascript">
        $('#myTable').DataTable({
            ...
            drawCallback: function(settings) {
                ...
                $(".infoct").click(function(e) {
                    $currID = $(this).attr("data-id");
                    $currTipe = $(this).attr("data-tipe");
                    $.get("modal_cetak_invoice/" + $currID + "/" + $currTipe, function(data) {
                        $('#cetak_data').html(data);
                        // console.log(data);
