<form method="post" id="update-form" action="{{ route('cetak_invoice_dua') }}">
    {{ csrf_field() }}
    <table class="table align-items-center table-flush">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <select name="tipe_pajak" id="pajak" class="form-control form-control-alternative pajak" aria-label="Tipe Pajak:" required>
