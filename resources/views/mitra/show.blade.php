@extends('layouts.app', ['activePage' => 'vendor']) @push('css')
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('vendor_data.create') }}" class="btn btn-sm btn-primary">Add Vendors</a>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="myTable" class="table align-items-center table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $x->TELEPHONE }}</td>
                                    <td>
                                        <button type="button" data-id="{{ $x->id }}" class="btn btn-round btn-info btn-sm infoU" data-toggle="modal" data-target="#alamat">
                                                    Detail </button>
                                    </td>
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('vendor_data.edit', $x->id) }}">Edit</a>
                                                <form method="post" id="delete-form-{{ $x->id }}" action="{{ route('vendor_data.destroy', $x->id) }}" style="display: none">
