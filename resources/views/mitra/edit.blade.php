                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('vendor_data.update', $vendor->id) }}" autocomplete="off">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group{{ $errors->has('npwp') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="npwp" id="input-npwp"
                                            ...
                                            placeholder="{{ __('npwp') }}" value="{{ $vendor->NPWP }}" required
                                            autofocus>
                                        @if ($errors->has('npwp'))
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="name" id="input-name"
                                            ...
                                            placeholder="{{ __('name') }}" value="{{ $vendor->VENDOR }}" required>
                                        @if ($errors->has('name'))
                                            <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group{{ $errors->has('alamat') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="alamat" class="form-control" id="area1" rows="3" placeholder="Alamat..." required>{{ $vendor->ADDRESS }}</textarea>
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('vendor_data.index') }}" type="button"
