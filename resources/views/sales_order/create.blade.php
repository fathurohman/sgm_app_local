                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('sales_order.store') }}" autocomplete="off" id="form-order">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div id="table-trans"></div>
                            </div>
                            <div class="this-trans">
                                <div class="row mt-2">
                                                ...
                                                <tbody class="selling">
                                                    <tr class="row-selling">
                                                        <td><input class="form-control autosuggest ui-widget"
                                                                type="text" id="description_s" name="description_s[]">
                                                        </td>
                                                        ...
                                                        <td><input class="form-control price" type="text"
                                                                id="price_s">
                                                        ...
                                                        <td><input type="text" id="name_s"
                                                                class="form-control name_s ui-widget" name="name_s[]">
                                                        </td>
