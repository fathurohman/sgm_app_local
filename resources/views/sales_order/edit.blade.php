                                    ...
                                    <table id="selling" class="table-selling align-items-center table-flush">
                                        ...
                                        <tbody class="selling">
                                            ...
                                            <tr class="row-selling">
                                                ...
                                                <td><input class="form-control qty" type="number" id="qty_s" name="qty_s[]" value="{{ $x->qty }}"></td>
                                                ...
                                                <td><input value="{{ $x->price }}" class="form-control price" type="number" id="price_s">
                                                    <input value="{{ $x->price }}" class="form-control price_real" type="text" id="price_s_r" name="price_s[]" hidden>
                                                </td>
                                                <td><input value="{{ $x->sub_total }}" class="form-control sub_total_s" id="sub_total_s"
                                                        name="sub_total_s[]" readonly>
                                                </td>
                                                <td><input value="{{ $x->name }}" type="text" id="name_s" class="form-control name_s ui-widget"
                                                        name="name_s[]">
                                                </td>
                                                <td><input value="{{ $x->remark }}" type="text" id="remark_s" class="form-control remark_s"
                                                        name="remark_s[]"></td>
                                                <td></td>
                                                {{--
                                    ...
                                    <table id="buying" class="table-buying align-items-center table-flush">
                                        ...
                                        <tbody class="buying">
                                            ...
                                            <tr class="row-buying">
                                                ...
                                                <td><input class="form-control qty" type="text" id="qty_b" name="qty_b[]" value="{{ $x->qty }}"></td>
                                                {{--
                                                ...
                                                <td><input type="text" class="form-control price" id="price_b" value="{{ $x->price }}">
                                                    <input type="text" class="form-control price_real" id="price_b_r" name="price_b[]" value="{{ $x->price }}" hidden>
                                                </td>
                                                <td><input type="text" class="form-control sub_total_b" id="sub_total_b" name="sub_total_b[]"
                                                        value="{{ $x->sub_total }}" readonly></td>
                                                <td><input type="text" value="{{ $x->name }}" class="form-control name_b ui-widget"
                                                        id="name_b" name="name_b[]">
                                                </td>
                                                <td><input type="text" class="form-control remark_b" value="{{ $x->remark }}"
                                        ...
                                        <tbody class="profit_tb">
                                            ...
                                            <tr class="profit_tr">
                                                <td><input value="{{ $x->currency }}" type="text" class="curr_prof" id="currency_prof"
                                                    ...
                                                    <input value="{{ $x->id }}" type="text" class="id_prof" id="id_prof" name="id_prof[]" hidden>
                                                </td>
