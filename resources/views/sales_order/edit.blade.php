    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('sales_order.update', $sales_order->id) }}" autocomplete="off" id="form-order">
                        @csrf @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" id="order_id" class="form-control form-control-alternative" required name="order_id_text" value="{{ $data_job->order_id }}"
                                    readonly>
                                <input id="order-id-hide" name="order_id" type="text" class="form-control" value="{{ $data_job->id }}" hidden>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <label class="form-control-label" for="input-tipe_order">{{ __('IDN/INV') }}</label>
                                <input type="text" id="tipe_order" class="form-control form-control-alternative" required name="tipe_order_text" value="{{ $data_job->tipe_order }}"
                                    readonly>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <label class="form-control-label" for="input-no_inv">{{ __('No. INV') }}</label>
                                <input name="no_inv" type="text" id="no_inv" value="{{ $sales_order->nomor_invoice }}" class="form-control form-control-alternative"
                                    required readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input id="Tanggal" name="Tanggal" value="{{ $data['tanggal'] }}" class="form-control" type="text" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input id="ETD" name="ETD" value="{{ $data_job->ETD }}" class="form-control" type="text" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input id="ETA" name="ETA" value="{{ $data_job->ETA }}" class="form-control" type="text" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('sales') ? ' has-danger' : '' }}">
                                    ...
                                    <input name="sales_id" type="text" id="sales_id" value="{{ $data['sales'] }}" class="form-control form-control-alternative"
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('vessel1') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="vessel1" id="input-vessel1" class="form-control form-control-alternative{{ $errors->has('vessel1') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('vessel1') }}" value="{{ $data_job->vessel1 }}" required readonly>                                    @if ($errors->has('vessel1'))
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('gwt_meas') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="gwt_meas" id="input-gwt_meas" class="form-control form-control-alternative{{ $errors->has('gwt_meas') ? ' is-invalid' : '' }}"
                                        value="{{ $data_job->GWT_MEAS }}" required readonly>                                    @if ($errors->has('gwt_meas'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('customer') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="customer" id="input-customer" class="form-control form-control-alternative{{ $errors->has('customer') ? ' is-invalid' : '' }}"
                                        value="{{ $data['shipper'] }}" required readonly>                                    @if ($errors->has('customer'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('vessel2') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="vessel2" id="input-vessel2" class="form-control form-control-alternative{{ $errors->has('vessel2') ? ' is-invalid' : '' }}"
                                        value="{{ $data_job->vessel2 }}" required readonly>                                    @if ($errors->has('vessel2'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('hbl') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="hbl" id="input-hbl" class="form-control form-control-alternative{{ $errors->has('hbl') ? ' is-invalid' : '' }}"
                                        value="{{ $data_job->HBL }}" required readonly> @if($errors->has('hbl'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('pol_pod') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="pol_pod" id="input-pol_pod" class="form-control form-control-alternative{{ $errors->has('pol_pod') ? ' is-invalid' : '' }}"
                                        value="{{ $data_job->pol_pod }}" required readonly>                                    @if($errors->has('pol_pod'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('party') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="party" id="input-party" class="form-control form-control-alternative{{ $errors->has('party') ? ' is-invalid' : '' }}"
                                        value="{{ $data_job->party }}" required readonly>                                    @if ($errors->has('party'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group{{ $errors->has('mbl') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mbl" id="input-mbl" class="form-control form-control-alternative{{ $errors->has('mbl') ? ' is-invalid' : '' }}"
                                        value="{{ $data_job->MBL }}" required readonly> @if($errors->has('mbl'))
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="table-responsive">
                                    <table id="selling" class="table align-items-center table-flush">
                                        <thead class="thead-light">
                                            ...
                                            <th style="background: #2493BF;"><a style="color:white" href="#" id="addkolom_s"><i class="fa fa-plus"></i>Add</a></th>
                                            <th style="background: #2493BF; color:white">Remove</th>
                                        </thead>
                                        <tbody class="selling">
                                            @foreach ($selling as $x)
                                            <tr class="row-selling">
                                                <td><input class="autosuggest ui-widget" type="text" id="description_s" value="{{ $x->description }}"
                                                        name="description_s[]">
                                                    <input type="text" name="id_selling[]" value="{{ $x->id }}" hidden>
                                                </td>
                                                <td><input class="qty" type="number" id="qty_s" name="qty_s[]" value="{{ $x->qty }}"></td>
                                                <td><select id="curr_s" name="curr_s[]" class="form-select curr_s" aria-label="Default select example">
                                                ...
                                                <td><input value="{{ $x->price }}" class="price" type="number" id="price_s" name="price_s[]"></td>
                                                <td><input value="{{ $x->sub_total }}" class="sub_total_s" id="sub_total_s" name="sub_total_s[]">
                                                </td>
                                                <td><input value="{{ $x->name }}" type="text" id="name_s" class="name_s ui-widget"
                                                        name="name_s[]">
                                                </td>
                                                <td><input value="{{ $x->remark }}" type="text" id="remark_s" class="remark_s"
                                                        name="remark_s[]"></td>
                                                <td></td>
                                                <td></td>
                                                {{--
                                ...
                                <div class="table-responsive">
                                    <table id="buying" class="table align-items-center table-flush">
                                        <thead class="thead-light">
                                            ...
                                            <th style="background: #BF2455;"><a style="color:white" href="#" id="addkolom_b"><i class="fa fa-plus"></i>Add</a></th>
                                            <th style="background: #BF2455; color:white">Remove</th>
                                        </thead>
                                        <tbody class="buying">
                                            @foreach ($buying as $x)
                                            <tr class="row-buying">
                                                <td><input type="text" class="autosuggest ui-widget" id="description_b" name="description_b[]"
                                                        value="{{ $x->description }}">
                                                    <input type="text" name="id_buying[]" value="{{ $x->id }}" hidden>
                                                </td>
                                                <td><input class="qty" type="text" id="qty_b" name="qty_b[]" value="{{ $x->qty }}"></td>
                                                {{--
                                                <td><input type="text" id="curr_b" name="curr_b[]"></td> --}}
                                                <td><select id="curr_b" name="curr_b[]" class="form-select curr_b" aria-label="Default select example">
                                                                <option selected>{{ $x->curr }}</option>
                                                                <option>IDR</option>
                                                                <option>SGD</option>
                                                                <option>USD</option>
                                                ...
                                                <td><input type="text" class="price" id="price_b" name="price_b[]" value="{{ $x->price }}"></td>
                                                <td><input type="text" class="sub_total_b" id="sub_total_b" name="sub_total_b[]"
                                                        value="{{ $x->sub_total }}"></td>
                                                <td><input type="text" value="{{ $x->name }}" class="name_b ui-widget" id="name_b"
                                                        name="name_b[]">
                                                </td>
                                                <td><input type="text" class="remark_b" value="{{ $x->remark }}" id="remark_b"
                                                        name="remark_b[]"></td>
                                                <td></td>
                                                <td></td>
                                                {{--
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="table-responsive">
                                    <table id="dp" class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input value="{{ $down_payment->customer }}" type="text" id="customer_dp"
                                                        name="customer_dp" readonly required>
                                                    <input type="text" value="{{ $down_payment->id }}" name="dp_id" hidden>
                                                </td>
                                                <td><input value="{{ $down_payment->currency }}" type="text" id="currency_dp"
                                                        name="currency_dp" readonly></td>
                                                <td><input value="{{ $down_payment->total }}" id="total_dp" name="total_dp" readonly
                                                        required></td>
                                                <td><input value="{{ $down_payment->dp }}" id="d_payment" name="dp" required></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12">
                                ...
                                <textarea name="notes" class="form-control" id="notes" rows="3" placeholder="Write a large text here ...">{{ $sales_order->notes }}</textarea>
                            </div>
                            {{--
                            <div class="col-lg-4 col-md-8 col-sm-12">
                                <label class="form-control-label" for="input-send">{{ __('send') }}</label>
                                <div class="custom-control custom-checkbox mb-3">
                                    <input name="published" class="custom-control-input" id="send" type="checkbox" value="1" @if ($sales_order->published
                                    == 1) {{ 'checked' }} @endif>
