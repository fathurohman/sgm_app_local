                                                ...
                                                @foreach ($buying as $x)
                                                    <tr class="row-buying">
                                                        ...
                                                        <td><input type="text" class="price" id="price_b"
                                                                name="price_b[]" value="{{ $x->price }}"></td>
                                                        <td><input type="text" class="sub_total_b" id="sub_total_b"
                                                                name="sub_total_b[]" value="{{ $x->sub_total }}"></td>
                                                        <td><input type="text" value="{{ $x->name }}"
                                                                class="name_b ui-widget" id="name_b" name="name_b[]">
                                                        </td>
                                                        <td><input type="text" class="remark_b"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input value="{{ $down_payment->customer }}" type="text"
                                                            id="customer_dp" name="customer_dp" readonly>
                                                ...
                                                @foreach ($profit as $x)
                                                    <tr class="profit_tr">
                                                        <td><input value="{{ $x->currency }}" type="text"
                                                                class="curr_prof" id="currency_prof" name="currency[]"
                                                                readonly></td>
                                                        <td><input value="{{ $x->total_selling }}" type="text"
                                                                id="total_selling" name="total_selling[]" readonly>
                                                        </td>
                                                        <td><input value="{{ $x->total_buying }}" type="text"
                                                                id="total_buying" name="total_buying[]" readonly>
                                                        </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-8 col-sm-12">
                                    ...
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input name="published" class="custom-control-input" id="send"
                                            type="checkbox" value="1"
                                            @if ($sales_order->published == 1) {{ 'checked' }} @endif>
